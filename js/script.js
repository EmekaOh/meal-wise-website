...
previous.addEventListener("click", function () {
  if (
    ...
    slides3.classList.remove("display-xlg-none");
    slides4.classList.remove("display-xlg-none");
  } else if (
    slides3.classList == "card background-white card-3 display-block" &&
    slides4.classList == "card background-white card-4 display-block"
  ) {
    slides4.classList.add("display-xlg-none");
    ...
    slides3.classList.add("display-xlg-none");
